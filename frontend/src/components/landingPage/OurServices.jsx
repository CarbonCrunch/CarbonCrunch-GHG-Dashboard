...
import image from './assets/image.png'; // Correctly imported image
...
const services = [
  ...
  },
  {
    ...
    reduce the organization carbon footprint by identifying the sources and quantities of GHG emissions.
...
const OurServices = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#1F568C] to-[#002952] min-h-screen py-12">
      ...
      {/* Services Navigation */}
      <div className="flex justify-center space-x-4 mb-14 overflow-x-auto scrollbar-hide px-4">
        {services.map((service, index) => (
          <button
            key={index}
            onClick={() => setSelectedServiceIndex(index)}
            className={`px-4 py-2 whitespace-nowrap rounded-full font-semibold transition-colors duration-300 ${
      ...
      <div className="flex flex-col h-[500px] mb-10 md:flex-row justify-center items-center max-w-6xl mx-auto bg-[#F3F9EE] rounded-lg shadow-lg transition-all duration-500 ease-in-out transform px-4 md:px-8">
        <div className="md:w-1/2 w-full mb-8 ml-6 md:mb-0">
