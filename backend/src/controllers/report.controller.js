...
export const updateEHCTDData = asyncHandler(async (req, res) => {
  const { reportId } = req.params;
  const { electricity, heating, cooling } = req.body;
  ...
  if (
    ...
    throw new ApiError(
      400,
      "Report ID, electricity, heating, and cooling are required."
    );
  }
...
export const updateECData = asyncHandler(async (req, res) => {
  ...
  if (!reportId || !distance || total === undefined) {
...
export const updateWaterData = asyncHandler(async (req, res) => {
  const { reportId } = req.params;
  const { supply, treatment, supplyCO2e, treatmentCO2e } = req.body;

  if (
    !reportId ||
    supply === undefined ||
    treatment === undefined ||
    supplyCO2e === undefined ||
    treatmentCO2e === undefined
  ) {
    throw new ApiError(
      400,
  ...
  report.water = { supply, treatment, supplyCO2e, treatmentCO2e };
...
export const updateHomeOfficeData = asyncHandler(async (req, res) => {
  ...
  if (
    ...
    !withCooling ||
    !noHeatingCooling ||
    withHeating.employees === undefined ||
    withHeating.workingRegime === undefined ||
    withHeating.workingFromHome === undefined ||
    withHeating.months === undefined ||
    withHeating.CO2e === undefined ||
    withCooling.employees === undefined ||
    withCooling.workingRegime === undefined ||
    withCooling.workingFromHome === undefined ||
    withCooling.months === undefined ||
    withCooling.CO2e === undefined ||
    noHeatingCooling.employees === undefined ||
    noHeatingCooling.workingRegime === undefined ||
    noHeatingCooling.workingFromHome === undefined ||
    noHeatingCooling.months === undefined ||
    noHeatingCooling.CO2e === undefined
  ) {
    throw new ApiError(
      400,
  ...
  report.homeOffice = { withHeating, withCooling, noHeatingCooling };
...
export const updateOwnedVehiclesData = asyncHandler(async (req, res) => {
  ...
  if (!reportId || !distances || total === undefined) {
...
export const updateFAData = asyncHandler(async (req, res) => {
  ...
  report.fa = { hotelRows, flightRows };
